...
<section id="banner" class="banner">
    <div class="content-banner">
        ...
        <a href="<?= getenv('APP_URL') ?>entrar.php">Registrate para realizar tu pedido</a>
    </div>
</section>
        ...
        <div class="container-blogs">
           <div class="card-blogs">
            <div class="container-img">
                ...
                <div class="button-group-blog">
                 <a href="<?= getenv('APP_URL') ?>destino2.php" target="_blank" style="text-decoration: none;">
                    <span>
           ...
           <div class="card-blogs">
            <div class="container-img">
                ...
                <div class="button-group-blog">
                    <a href="<?= getenv('APP_URL') ?>destino3.php" target="_blank" style="text-decoration: none;">
                    <span>
                        <i class="fa-solid fa-magnifying-glass"></i>
                    </span>
           ...
           <div class="card-blogs">
            <div class="container-img">
                ...
                <div class="button-group-blog">
                 <a href="<?= getenv('APP_URL') ?>destino.php" target="_blank" style="text-decoration: none;">
                    <span>
                        <i class="fa-solid fa-magnifying-glass"></i>
                    </span>

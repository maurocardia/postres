...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            <li><a href="<?= $_ENV['APP_URL'] ?>/postres/usuario.php" target="_blank">Registro Usuarios</a></li>
            <li><a href="baseuser.php">Usuarios</a></li>
            <li><a href="basepedidos.php">Pedidos</a></li>
            <li><a href="<?= $_ENV['APP_URL'] ?>/postres/postre.php">Editar Mejores productos</a></li>
            ...
            <li><a href="<?= $_ENV['APP_URL'] ?>/postres/">Cerrar Sesión</a></li>
        </ul>
    </div>
</body>
</html>
